...
<body>
    <main class="bg-white mx-auto">
        ...
        <main class="container bg-white m-5 mx-auto p-4">
            <div class="row">
                <h1 class="text-center">Le Bon Appart - Accueil</h1>
                <p class="text-center">Nos dernières annonces :</p>
                <?php
                $requete = $pdoSITE->query("SELECT * FROM advert ORDER BY id DESC LIMIT 15");
